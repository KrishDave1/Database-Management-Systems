...
// Given the phone number to be searched, if found store the record in the contact pointer sent as an argument.
...
// Return CONTACT_SUCCESS if the contact is successfully deleted.
